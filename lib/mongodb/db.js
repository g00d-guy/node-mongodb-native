...
Db.connect = function(url, options, callback) {
  ...
  for(var i = 0; i < object.servers.length; i++) {
    ...
    var _server = object.servers[i].domain_socket 
        ? new Server(object.servers[i].domain_socket, {socketOptions:{connectTimeoutMS:30000}, auto_reconnect:true})
        : new Server(object.servers[i].host, object.servers[i].port, {socketOptions:{connectTimeoutMS:30000}, auto_reconnect:true});
